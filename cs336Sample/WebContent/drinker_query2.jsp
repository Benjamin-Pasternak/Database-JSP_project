...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		String graphType = request.getParameter("drinker2");   
   		//Make a query
   		String query = "select t.item, sum(t.quantity) from bills b, transactions t where t.bill_id = b.bill_id and b.drinker = \'" + String.format("%s", graphType) + "\' and t.type =  \'beer\' group by t.item;" ;
   		...
   		while (result.next()) { 
   			...
   			map.put(result.getString("t.item"),result.getInt("sum(t.quantity)"));
   			list.add(map);
   	    } 
   	    result.close();
        ...
        chartTitle = "Beers that " + String.format("%s", graphType) + "ordered most frequently";
        legend = "beers";
