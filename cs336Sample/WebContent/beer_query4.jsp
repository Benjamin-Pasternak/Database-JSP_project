...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		String beer4 = request.getParameter("beer4");
   		//Make a query
   		String query = "select b.day, sum(t.quantity) from bills b, transactions t where t.bill_id = b.bill_id and t.item = \'" + String.format("%s", beer4) + "\' group by b.day order by b.day ASC";
   		//out.print(query);
   		...
   		while (result.next()) { 
   			...
   			map.put(result.getString("b.day"),result.getInt("sum(t.quantity)"));
   			list.add(map);
   	    } 
   	    result.close();
        ...
        chartTitle = "Time distribution per day of week for" + String.format("%s", beer4);
