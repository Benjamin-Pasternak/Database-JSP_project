...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		String drinker3 = request.getParameter("drinker3");
   		String month3 = request.getParameter("month3");
   		//Make a query
   		String query = "select b.day, sum(b.total_price) from bills b where month(date) = " + String.format("%s", month3) +" and b.drinker = \'" + String.format("%s", drinker3) + "\' group by b.day order by b.day ASC";
   		...
   		while (result.next()) { 
   			...
   			map.put(result.getString("b.day"),result.getInt("sum(b.total_price)"));
   			list.add(map);
   	    } 
   	    result.close();
        ...
        chartTitle = "Total spent on " + String.format("%s", month3) + " month on the days of the week on record";
        legend = "$ Spent";
