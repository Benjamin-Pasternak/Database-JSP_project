...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		String bar4 = request.getParameter("bar4");
   		//Make a query
   		String query = "select Hour(b.time), count(*) from bills b where b.bar = \'" + String.format("%s", bar4) + "\' group by Hour(b.time) order by Hour(b.time)";
   		//out.print(query);
   		...
   		while (result.next()) { 
   			...
   			map.put(result.getString("Hour(b.time)"),result.getInt("count(*)"));
   			list.add(map);
   	    } 
   	    result.close();
        ...
        chartTitle = "busiest time of the day for" + String.format("%s", bar4);
