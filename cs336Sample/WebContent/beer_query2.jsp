...
<body>
	...
	<% try {
			...
			String beer2 = request.getParameter("beer2");
			//out.println(newBar);
			...
			String  str = "select b.drinker, sum(t.quantity) from bills b, transactions t where t.bill_id = b.bill_id and t.item = \'" + String.format("%s", beer2) + "\' group by b.drinker order by sum(t.quantity) desc";
