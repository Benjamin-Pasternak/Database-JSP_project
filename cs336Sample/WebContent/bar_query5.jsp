...
<% 
	...
	try{
		...
		ArrayList<Map<String,Integer>> list = new ArrayList();
   		...
   		String bar5 = request.getParameter("bar5");
   		//Make a query
   		String query = "select b.day, count(*) from bills b where b.bar = \'" + String.format("%s", bar5) + "\' group by b.day order by b.day";
   		//out.print(query);
   		...
   		while (result.next()) { 
   			...
   			map.put(result.getString("b.day"),result.getInt("count(*)"));
   			list.add(map);
   	    } 
   	    result.close();
        ...
        chartTitle = "busiest days of the week for" + String.format("%s", bar5);
